           ...
           if(step.keySet().contains("implicitly_wait")){
            ...
            if(step.keySet().contains("send_keys")) {
                ...
                data.forEach(search->{
                    ...
                    currentElement.sendKeys(search);
                    //System.out.println(step.get("assert").toString());
                    //assertElement = driver.findElement(By.xpath(step.get("assert").toString()));
                    //System.out.println(assertElement.getText());
                    //assertEquals(assertElement.getText(),search);
